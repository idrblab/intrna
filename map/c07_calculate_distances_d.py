...
def caldis(data, idx, tag, savepath,methods = ['cosine']):
...
# datapath = '/public/home/wangyx/01_MolMap/Data/RNAmap_Descriptor/dup_Data/Descriptors_417909_772.csv'
def calculate_distance_d(datapath,savepath):
    ...
    tag = 'descriptor'
    caldis(Ddata, idx, tag, savepath,methods = ['cosine'])
...
# if __name__ == '__main__':
    ...
    # data_nm = pd.read_csv('/public/home/wangyx/01_MolMap/Data/RNAmap_Descriptor/dup_Data/Descriptors_417909_772.csv')
    # data = np.array(data_nm.iloc[:,1:])
    # # 特征归一化到[0,1]的范围
    # min_max_scaler = MinMaxScaler()
    # Ddata = min_max_scaler.fit_transform(data)#归一化后的结果
